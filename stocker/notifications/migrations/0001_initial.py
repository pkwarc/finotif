# Generated by Django 3.2.7 on 2021-11-03 22:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('em', 'Email'), ('ph', 'Push')], default='em', max_length=2)),
                ('is_active', models.BooleanField(default=True)),
                ('step', models.DecimalField(decimal_places=2, help_text='Send a notification when the change in a ticker price is equal to the step', max_digits=12)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            name='PriceStepNotificationState',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('modified_at', models.DateTimeField(auto_now=True)),
                ('last_step', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='notifications.tickerstate')),
                ('notification', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='notifications.pricestepnotification')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='pricestepnotification',
            name='ticker',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='notifications.ticker'),
        ),
        migrations.AddField(
            model_name='pricestepnotification',
            name='user',
