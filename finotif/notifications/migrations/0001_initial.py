...
import finotif.notifications.models
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('property', models.IntegerField(choices=[(0, 'PRICE'), (1, 'VOLUME'), (2, 'ASK'), (3, 'ASK_SIZE'), (4, 'BID'), (5, 'BID_SIZE')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('property', models.IntegerField(choices=[(0, 'PRICE'), (1, 'VOLUME'), (2, 'ASK'), (3, 'ASK_SIZE'), (4, 'BID'), (5, 'BID_SIZE')])),
                ('change', models.FloatField(help_text='Send the notification when a property of the ticker increased/decreased by the value of this field', validators=[finotif.notifications.models.validate_greater_than_zero])),
